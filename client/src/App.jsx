...
import SavollarJavoblar from './components/SavollarJavoblar'; // About sahifasi
            ...
            <div className="app-container">
                ...
                <nav>
                    <ul>
                        ...
                        <li>
                            <Link to="/quiz">Quiz</Link> {/* Quiz sahifaga link */}
                        </li>
                    </ul>
                </nav>
                ...
                <Routes>
                    ...
                    {/* <Route path="/quiz" element={<Quiz />} /> Quiz sahifasi */}
                </Routes>
            </div>
        </Router>
    );
