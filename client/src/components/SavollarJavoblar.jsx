...
const Quiz = () => {
    ...
    useEffect(() => {
        const fetchSubjects = async () => {
            try {
                const response = await axios.get('https://sinftest.onrender.com/api/subjectlar');
    ...
    useEffect(() => {
        const fetchQuestions = async () => {
            ...
            try {
                const response = await axios.get(`https://sinftest.onrender.com/api/questions/subject/${selectedSubject}`); // Tanlangan fanga ko'ra savollarni olish
    ...
    const submitAnswers = async () => {
        ...
        try {
            const response = await axios.post(
                'https://sinftest.onrender.com/api/submit-answers',
                {
