...
const Quiz = () => {
    ...
    useEffect(() => {
        const fetchSubjects = async () => {
            try {
                const response = await axios.get('http://localhost:5173/api/subjectlar');
    ...
    useEffect(() => {
        const fetchQuestions = async () => {
            ...
            try {
                const response = await axios.get(`http://localhost:5173/api/questions/subject/${selectedSubject}`); // Tanlangan fanga ko'ra savollarni olish
    ...
    const submitAnswers = async () => {
        ...
        try {
            const response = await axios.post(
                'http://localhost:5173/api/submit-answers',
                {
