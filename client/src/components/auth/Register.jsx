...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            navigate('/login'); // Muvaffaqiyatli ro'yxatdan o'tgandan so'ng kirish sahifasiga o'tish
        } catch (err) {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
            <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
                <h2 className="text-2xl font-bold text-center text-blue-600 mb-6">Ro'yxatdan o'tish</h2>
                {error && <p className="text-red-500 mb-4">{error}</p>}
                <form onSubmit={handleSubmit}>
                    <div className="mb-4">
                        <label className="block text-gray-700 font-bold mb-2" htmlFor="name">Ismingiz</label>
                        <input
                            type="text"
                            id="name"
                            value={name}
