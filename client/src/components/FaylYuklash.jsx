...
const navigate = useNavigate()
  ...
  useEffect(() => {
    const fetchSubjects = async () => {
      try {
        ...
        const response = await axios.get(`https://sinftest2.onrender.com/api/subjects${fanId}`,
          {
            headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://sinftest2.onrender.com/api/upload', formData, {
        headers: {
