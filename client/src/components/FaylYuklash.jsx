...
const navigate = useNavigate()
  ...
  useEffect(() => {
    const fetchSubjects = async () => {
      try {
        ...
        const response = await axios.get(`https://sinftest-backend.onrender.com/api/subjects${fanId}`,
          {
            headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://sinftest-backend.onrender.com/api/upload', formData, {
        headers: {
